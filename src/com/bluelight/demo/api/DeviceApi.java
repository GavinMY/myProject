...
public class DeviceApi {
	...
	private static final String authorizeUrl="https://api.weixin.qq.com/device/getqrcode?access_token=ACCESS_TOKEN&product_id=PRODUCT_ID";
	/**
	 * 向设备推送消息
	 */
 ...
 * 设备授权新接口
 * */
	public static String newauthorize(List<DeviceAuth> devices, boolean isCreate) {
		JSONObject json = new JSONObject();
		json.put("device_num", String.valueOf(devices.size()));
		json.put("op_type", isCreate ? "0" : "1");// 请求操作的类型 0：设备授权（缺省值为0）
													// 1：设备更新（更新已授权设备的各属性值）
	...
	public static void main(String[] args) {
		String deviceId = "D03972C85FFB";

		// 查询状态
//		 System.out.println("状态:"+getStat(deviceId));
		
		 String openid = "o3yS0uLDTYHDcN0BQIEqiRGYnDaQ";
		 String deviceType = "gh_4614a9169b8e";
		// String openid=getOpenId(deviceType,deviceId);
