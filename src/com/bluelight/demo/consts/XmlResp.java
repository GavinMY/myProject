...
public class XmlResp {
	 ...
	 * 连接消息响应格式
	 */
	public static final String Link = new StringBuilder()
	.append("<xml>")
	.append("<ToUserName><![CDATA[%s]]></ToUserName>")
	.append("<FromUserName><![CDATA[%s]]></FromUserName>")
	.append("<CreateTime>%s</CreateTime>")
	 ...
	 * 构造文本消息响应
	 */
	public static final String buildNewsMessage(String toUser, String fromUser, String title,String desc,String pic,String url) {
		return String.format(Link, toUser, fromUser, time(), MsgType.NEWS, title,desc,pic,url);
	}
