...
import com.bluelight.entry.Article;
import com.bluelight.entry.Music;
import com.bluelight.entry.SNSUserInfo;
import com.bluelight.entry.WeixinGroup;
import com.bluelight.entry.WeixinMedia;
import com.bluelight.entry.WeixinOauth2Token;
import com.bluelight.entry.WeixinQRCode;
import com.bluelight.entry.WeixinUserInfo;
import com.bluelight.entry.WeixinUserList;
import com.bluelight.tools.DownloadImage;
...
public class AdvancedUtil {
	...
	public static SNSUserInfo getSNSUserInfo(String accessToken, String openId,String filepath) {
		...
		if (null != jsonObject) {
			try {
				...
				if(Dimage.down(jsonObject.getString("openid"),jsonObject.getString("headimgurl"),filepath))
				{
					// 用户头像
					snsUserInfo.setHeadImgUrl("dhj/images/"+jsonObject.getString("openid")+".gif");
				}				
				// 用户的标识
				...
				// 性别（1是男性，2是女性，0是未知）
				System.out.println("性别"+jsonObject.getInt("sex"));
